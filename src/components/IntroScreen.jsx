...
const Hero = () => {
    return(
        ...
        <div className="titleContainer">
          ...
          <h1 className="tracking-in-expand-fwd">Ngọc Mai Music</h1>
          <h3 className="subTitle"> Web Nghe Nhạc Dành Riếng Cho Mei </h3>
          ...
          <div class="wrap">
            <Link to="/music">
                <button class="button">Bắt Đầu Thoii</button>
            </Link>         
          </div>
        </div>
        <ReactPlayer 
